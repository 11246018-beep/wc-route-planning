...
def main():
    ...
    out_map = os.path.join(project_dir, 'output', 'Weekly_Routing_Map_CrossCounty.html')
    m.save(out_map)
    ...
    out_sched = os.path.join(project_dir, 'output', 'Weekly_Schedule_Summary_CrossCounty.xlsx')
    ...
    out_daily = os.path.join(project_dir, 'output', 'Daily_Route_Summary_CrossCounty.xlsx')
    daily_summary.to_excel(out_daily, index=False)
    
    print("Done! Saved Weekly_Schedule_Summary_CrossCounty.xlsx, Daily_Route_Summary_CrossCounty.xlsx and Weekly_Routing_Map_CrossCounty.html to output folder")
