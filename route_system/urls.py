...
urlpatterns = [
    ...
    path("reports/", manager_page("routing/report_page.html"), name="report_page"),
    path("driver-admin/", manager_page("routing/driver_admin.html"), name="driver_admin_page"),
    path("live-monitor/", manager_page("routing/live_monitor.html"), name="live_monitor_page"),
    ...
    path("cleaning-records/", manager_page("routing/cleaning_records.html"), name="cleaning_records_page"),
    path("cleaning-report/", manager_page("routing/cleaning_report.html")),

    path("api/routes/options/", manager_api(views.api_route_options), name="api_route_options"),
    path("api/routes/detail/", manager_api(views.api_route_detail), name="api_route_detail"),
    path("api/routes/search-point/", manager_api(views.api_search_point_route), name="api_search_point_route"),
    path("api/routes/old-options/", manager_api(views.api_old_route_options), name="api_old_route_options"),
    path("api/routes/old-detail/", manager_api(views.api_old_route_detail), name="api_old_route_detail"),
    path("api/points/page/", manager_api(views.api_points_page), name="api_points_page"),
    ...
    path("api/admin/drivers/", manager_api(account_api.admin_drivers_api), name="admin_drivers_api"),
    ...
    path("api/admin/live/overview/", manager_api(live_api.admin_live_overview_api), name="admin_live_overview_api"),
    path("api/admin/live/reset-progress/", manager_api(live_api.admin_live_reset_progress_api), name="admin_live_reset_progress_api"),
    path("api/admin/cleaning-records/", manager_api(mobile_api.admin_cleaning_records_api), name="admin_cleaning_records_api"),
    path("api/admin/cleaning-record/delete/", mobile_api.admin_cleaning_record_delete_api, name="admin_cleaning_record_delete_api"),
    path("api/admin/cleaning-summary/", manager_api(mobile_api.admin_cleaning_summary_api), name="admin_cleaning_summary_api"),
    path("api/toilet-demand-analysis/", manager_api(views.toilet_demand_analysis_api)),
