...
def main():
    print("Loading data...")
    df = pd.read_csv('output/processed_nodes_phase1.csv')
    ...
    # 【舊】原始路線繪製區塊
    try:
        old_file_path = 'data/202512221227週維護排程.xlsx'
    ...
    m.save('output/Weekly_Routing_Map.html')
    ...
    sched_df_excel.to_excel('output/Weekly_Schedule_Summary.xlsx', index=False)
    ...
    daily_summary.to_excel('output/Daily_Route_Summary.xlsx', index=False)
